#ifndef VH_APP_COUPLER_FAMILY_GROUP_H_
#define VH_APP_COUPLER_FAMILY_GROUP_H_
...
namespace esc {
///
struct CouplerFamilyGroup : public core::IFamilyGroup {
 public:
  ///
...
#endif  // VH_APP_COUPLER_FAMILY_GROUP_H_
