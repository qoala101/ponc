...
#ifndef VH_PONC_APP_COUPLER_FAMILY_GROUP_H_
#define VH_PONC_APP_COUPLER_FAMILY_GROUP_H_
...
namespace vh::ponc {
///
class CouplerFamilyGroup : public core::IFamilyGroup {
 public:
  ///
...
#endif  // VH_PONC_APP_COUPLER_FAMILY_GROUP_H_
